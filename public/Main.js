...
let pic_price = document.getElementById("pic-price");
let pic_name = document.getElementById("pic-name");
let pic_preview = document.getElementById("pic-preview");
let search = document.getElementById("pic-search");
let price_edit = document.getElementById("pic-price-edit");
let name_edit = document.getElementById("pic-name-edit");
let preview_edit = document.getElementById("pic-preview-edit");
